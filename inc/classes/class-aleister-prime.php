...
class Aleister_Prime {
	...
	protected function setup_hooks() {
		...
		add_action( 'admin_head', array( $this, 'aleister_prime_admin_colors' ) );
	}
	...
	public function setup_theme() {
		...
		*/
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'aleister_prime_custom_background_args',
				array(
	...
	/**
	 * Change Default WordPress default post menu icon.
	 *
	 * @return void
	 * @since 1.0.0
	 */
	public function aleister_prime_admin_colors() {
		?>
			<style>
				/* Colors
				Dark Red: 
